---
title: Schedule - Introduction to Single-cell RNA-seq
sidebar: false
toc: false
execute: 
  eval: false
...
- [Raw data to count matrix](../lessons/02_generation_of_count_matrix.qmd)
- [Download this project](https://www.dropbox.com/scl/fi/uoro3sbex3tj1e6m61z16/single_cell_rnaseq.zip?rlkey=cfay7tqm3ta5qlh2gph7h2wko&st=fcxgae45&dl=1)
...
| 09:45 - 10:35| [Introduction to Single Cell RNA-sequencing: a practical guide](../slides/HBC_single_cell_analysis_course-SEP_2025.pdf) | [Dr. Mandovi Chatterjee](https://singlecellcore.hms.harvard.edu/people/mandovi-chatterjee) |
| 10:35 - 10:40 | Break |
...
# Quality control of CellRanger counts - Preview
...
| 10:00 - 10:45 | [Quality control with additional metrics](../lessons/05_quality_control.qmd) | Noor |
| 10:45 - 10:50 | Break |
| 10:50 - 11:40 | [Normalization and regressing out unwanted variation](../lessons/07_SCT_normalization.qmd) | Noor |
| 11:40 - 12:00| [A brief introduction to Integration](../lessons/08_integration_cca_theory.qmd) | Will |
...
:::{.callout-note collapse="true"}
# Running CCA integration and complex integration tasks - Preview
...
|:-----------:|:----------:|:--------:|
| 09:30 - 10:00 | Self-learning lessons discussion | All |
| 10:00 - 11:00 | [Clustering](../lessons/10_clustering_cells_SCT.qmd) | Noor |
| 11:00 - 11:05 | Break |
| 11:05 - 12:00 | [Clustering quality control](../lessons/11_clustering_quality_control.qmd) | Noor |
