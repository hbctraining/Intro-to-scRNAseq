...
You can copy and paste the output into [this app](https://hcbc.connect.hms.harvard.edu/scRNA_sessionInfo_checks/) to ensure that all of the packages were installed correctly.
