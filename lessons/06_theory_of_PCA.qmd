...
```{python}
#| label: plot_recentered_data_Python
# Set the theme to "whitegrid"
sns.set(style="whitegrid")
...
```{python}
#| label: plotting_PCA_hand_Python
# Set the theme to "whitegrid"
sns.set(style="whitegrid")
