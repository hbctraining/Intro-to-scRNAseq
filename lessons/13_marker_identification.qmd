...
::: {#fig-sc-umap-sctv2 .figure}
![](../img/SC_umap_SCTv2.png){width=800}

UMAP visualization of cells after SCT normalization and CCA integration, colored by cluster identity.
:::
...
::: callout-note
# Why we are not running `FindAllMarkers()`
...
Schematic of identifying conserved markers across conditions for a given cluster (`FindConservedMarkers`).
:::
...
Schematic of identifying markers differentiating one cluster from specific comparison clusters (FindMarkers).
:::
