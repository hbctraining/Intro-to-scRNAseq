...
Schematic representation of K-nearest neighbor–based clustering for single-cell RNA-seq data.  
_Source: [Analysis of Single cell RNA-seq data](https://biocellgen-public.svi.edu.au/mig_2019_scrnaseq-workshop/clustering-and-cell-n.html)_
:::
