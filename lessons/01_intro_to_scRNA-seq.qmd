...
description: |
  This lesson introduces participants to the steps of setting up a single-cell RNA‑seq project. Participants will learn when to consider using scRNA-seq as well as the challenges that scRNA-seq provide. 
author:
  - Mary Piper
  - Meeta Mistry
  - Radhika Khetani
