...
description: |
  This lesson introduces participants to the steps of setting up a single-cell RNA‑seq project in R. Participants will learn how to organize project files, understand the structure and source of the example dataset and apply good data management practices. The lesson also provides context on scRNA‑seq concepts, metadata and expected cell types to prepare participants for quality control and subsequent analytic steps.
author:
  - Mary Piper
  - Meeta Mistry
  - Radhika Khetani
