...
#| fig-cap: Histogram plot showing the distribution of UMI counts per cell for each sample
# Visualize the number UMIs/transcripts per cell
fig, ax = plt.subplots()
...
#| fig-cap: Histogram plot showing the distribution of genes detected per cell for each sample
# Visualize the distribution of genes detected per cell via histogram
ax = sns.histplot(merged_adata.obs, 
                  x = "n_genes", 
                  hue = "sample",
...
#| fig-cap: Histogram plot showing the overall complexity of gene expression per cell for each sample
ax = sns.histplot(merged_adata.obs, 
...
#| fig-cap: Histogram plot showing the distribution of mitochondrial gene expression detected per cell for each sample.
...
```{r}
#| label: reassign_filtered_counts
