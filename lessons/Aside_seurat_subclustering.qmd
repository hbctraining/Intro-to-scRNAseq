---
title: "Subclustering scRNA-seq datasets"
description: |
  This lesson guides participants through approaches for subclustering single‑cell RNA‑seq datasets in Seurat. It outlines how to subset specific cell types, compares strategies for identifying finer cellular subtypes and highlights considerations when working with smaller datasets, including parameter selection for clustering and integration.
author:
  - Meeta Mistry
  - Noor Sohail
  - Will Gammerdinger
