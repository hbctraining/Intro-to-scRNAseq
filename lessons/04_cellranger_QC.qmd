---
title: "Cell Ranger Quality Summaries"
description: |
...
Overview of the Cell Ranger gene expression workflow.<br>
...
metrics_list = []
for sample in samples:
    path_csv = f"data/cellranger_outs/{sample}_metrics_summary.csv"
...
With all of this information available as a dataframe, we can use pandas to visualize these values. As an example of how this information can be used, we can display what percentage of reads map to the various parts of the genome (Intergentic, Intronic, and Exonic).
...
df_long["value"] = df_long["value"].str.rstrip("%").astype(float)
