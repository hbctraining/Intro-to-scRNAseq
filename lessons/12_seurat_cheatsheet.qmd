...
Load in the `integrated_seurat` object that is available in the `data` folder of the project. The link to download the project was provided on [the schedule page](../schedule/schedule.qmd) but can also be [found here](https://www.dropbox.com/s/vop78wq76h02a2f/single_cell_rnaseq.zip?dl=1).
...
```{r}
#| label: show_loadings
# seurat_integrated[['pca']]@feature.loadings
