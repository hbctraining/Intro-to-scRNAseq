...
description: |
  In this lesson, participants learn how to determine the appropriate number of principal components (PCs) to use in downstream single-cell RNA-seq analyses by combining visual and quantitative approaches. After generating an elbow plot with Seurat, participants explore two complementary metrics that identify where variance contributions taper off. By comparing cumulative variance explained and percent changes between consecutive PCs, participants gain an understanding of how many PCs capture the majority of biological signal for clustering.
author:
  - Meeta Mistry
  - Amélie Julé
  - Will Gammerdinger
