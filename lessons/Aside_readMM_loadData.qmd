...
description: |
  This lesson introduces participants to creating a Seurat object starting from raw single‑cell RNA‑seq count files. Participants learn how gene, barcode and matrix files are structured, how to load them into R and how to generate a sparse count matrix to improve efficiency when working with large datasets.
author:
  - Mary Piper
  - Lorena Pantano
  - Meeta Mistry
