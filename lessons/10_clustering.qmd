...
# Load data
seurat_integrated <- readRDS("integrated/08_seurat_integrated")
...
#| fig-cap: Ranking of top genes in the first 3 principal components, showing the top and bottom 15
